...
$lang["menu_trade"] = "Trade Details";
$lang["menu_trade_report_view"] = "304_trade_report";

$lang["menu_manager"] = "Manage";
$lang["menu_manager_info"] = "901_manage_info";
...
$lang["menu_notify"] = "Notify";


$lang["btn_title_prev"] = "Previous";
$lang["btn_title_next"] = "Next";
$lang["btn_title_create"] = "Create";
$lang["btn_title_register"] = "Register";
$lang["btn_title_modify"] = "Modify";
$lang["btn_title_update"] = "Update";
$lang["btn_title_cancel"] = "Cancel";
$lang["btn_title_search"] = "Search";
$lang["btn_title_delete"] = "Delete";
$lang["btn_title_save"] = "Save";
$lang["btn_select_all"] = "All";
...
// 유저관리
$lang["users_userinfo_title"]   = "User Info";
$lang["users_userinfo_explain"] = "Search  users' information";
$lang["users_userinfo_search"] = "Search:";
$lang["users_userinfo_basket"] = "Basket";
$lang["users_userinfo_fields"] = Array("Basket",	"Account",	"Name",	"Balance",	"PrevBal.",	"PrevMonBal.",	"Leverage",	"Interate",	"PrevEquity",	"PrevMonEquity",	"Group",	"AgentAccNo",	"Status",	"RegDate",	"LastDate",	"LastUpddate",	"Phone",	"Email",	"Country",	"City",	"State","Zipcode");
...
// designate_omni 관리
$lang["configuration_designate_omni_title"]   = "< Designate Omnibus Account>";
$lang["configuration_designate_omni_explain"] = "Search  Designate Omnibus' information";
$lang["configuration_designate_omni_fields"] = Array("Omni Account",	"ACCOUNT_NAME",	"GROUP");

// Mark_bridge 다이얼로그
$lang["configuration_designate_omni_dlg_create_title"]   = "designate_omni Create";
$lang["configuration_designate_omni_dlg_create_fields"]   = Array("ACCOUNT", "GROUP", "RESULT");
...
$lang["configuration_settle_price_fields"] = Array("SYMBOL", "MARKTE_RATE");
...
$lang["statement_settle_summary_date"] = "Date";
...
$lang["statement_closed_orders_fields_1"] = Array("W/L Client",	"PnL",	"Volume",	"Swap" ,"Agent Comm", "Mark-up Comm",	"FBP Total PnL");
...
$lang['msg_err_array'] = Array("Manager ID does not exist.", 										// 0
								 "Target Manager ID does not exist.", 								// 1
								 "Manager ID already exists.", 										// 2
								 "It is wrong password.", 											// 3
								 "Only admin can create a new manager.",							// 4
								 "Only admin can modify another manager information.", 				// 5
								 "LP ID does not exist.", 											// 6
								 "Company Name does not exist.", 									// 7
								 "User account does not exist.", 									// 8
								 "Today is Sunday or Monday. Batch process does not proceed.");		// 9