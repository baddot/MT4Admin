		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
                    <?php echo $arr_ui_string['configuration_lp_account_dlg_create_title']?> 
                </h4>
			</div>
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<select class="selectpicker" id="cb_create_lp_id"
								data-width="auto">
		            		<?php
																$arr = $list_lp;
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['configuration_lp_account_fields'][2]?>" class="form-control"  id="tv_create_lp_name">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['lp_info_fields'][4]?>" class="form-control"  id="tv_create_comments">
						</div>
					</div>
				</form>
			</div>
