...
<div id="page-wrapper">
	<div id="page-inner">
		<div class="row">
			<div class="col-md-12">
				<h2><?php echo $arr_ui_string["statement_opened_orders_title"]?></h2>
				<h5><?php echo $arr_ui_string["statement_opened_orders_explain"]?></h5>
			</div>
		</div>
		<!-- /. ROW  -->
		<hr />
								...
								<div class="col-md-9 form-group">
									<div id="from-date-container" style="width: 100%;">
						                <table>
						                    <tbody>
						                    <tr>
						                    	<td><?php echo  $arr_ui_string["statement_opened_orders_date"]?></td>
		...
		<div class="row">
			...
			<div class="panel panel-default">
				<div class="panel-heading panel-table-heading-custom">
					<h3 class="panel-title"><?php echo $arr_ui_string["statement_opened_orders_table_expain"][0]?></h3>
				</div>
							...
							<table
								...
								<thead>
									<tr>
								 	 <?php
								 	 	$i = 0;
											foreach ( $arr_ui_string ["statement_opened_orders_fields_1"] as $row ) {
		...
		<div class="row">
			...
			<div class="panel panel-default">
				<div class="panel-heading panel-table-heading-custom">
					<h3 class="panel-title"><?php echo $arr_ui_string["statement_opened_orders_table_expain"][1]?></h3>
				</div>
				<div class="panel-body">
							...
							<table
								...
								<thead>
									<tr>
								 	 <?php
								 	 	$i = 0;
											foreach ( $arr_ui_string ["statement_opened_orders_fields_2"] as $row ) {
...
<script>
    ...
    function onLoad() {
    	   $('#fromDate').on('change', function(){
				 ...
				 var urlData = baseURL+"statement/GET_OPENED_ORDERS_VIEW";
    	   ...
    	   var baseURL = "<?php echo base_url(); ?>";
			...
			urlData = baseURL+"statement/GET_OPENED_ORDERS_VIEW";
			...
			dataTable = $('#dataTables-example_2').dataTable({
			    ...
			    "ajax": {
				 ...
				 "columns": [
				             ...
				             { "data": "VOLUME" , "class": "alignCenter"},
				             { "data": "0" , "class": "alignCenter"},//{ "data": "FIXED_CLOSED_PRICE" , "class": "alignCenter"},
				             { "data": "CLOSE_PRICE" , "class": "alignCenter"},
				             { "data": "SWAPS" , "class": "alignCenter"},
				             { "data": "CONV2" , "class": "alignCenter"},
				             { "data": "0" , "class": "alignCenter"},//{ "data": "FIXED_PROFIT" , "class": "alignCenter"},
