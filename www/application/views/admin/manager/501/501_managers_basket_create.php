			...
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['managers_basket_group_fields'][1]?>" class="form-control"  id="tv_create_name">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['managers_basket_info_fields'][2]?>" class="form-control"  id="tv_create_comment">
						</div>
					</div>
