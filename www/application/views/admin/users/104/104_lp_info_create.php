		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
                    <?php echo $arr_ui_string['lp_dlg_create_title']?> 
                </h4>
			</div>
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['lp_info_fields'][1]?>" class="form-control"  id="tv_create_lp_name">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<select class="selectpicker" id="cb_create_status"
								data-width="auto">
		            		<?php
																$arr = Array('Y', 'N');
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['lp_info_fields'][3].'1'?>" class="form-control"  id="tv_create_phone_1">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['lp_info_fields'][3].'2'?>" class="form-control"  id="tv_create_phone_2">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['lp_info_fields'][5]?>" class="form-control"  id="tv_create_address">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="textinput"><?php echo $arr_ui_string['lp_info_fields'][4]?></label>
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['lp_info_fields'][4]?>" class="form-control"  id="tv_create_email">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="textinput"><?php echo $arr_ui_string['lp_info_fields'][6]?></label>
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['lp_info_fields'][6]?>" class="form-control"  id="tv_create_comment">
						</div>
					</div>
