		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title">
                    <?php echo $arr_ui_string['ib_dlg_create_title']?> 
                </h4>
			</div>
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<select class="selectpicker" id="cb_create_agent_name"
								>
		            		<?php
																$arr = $list_agent;
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<label class="col-sm-3 control-label" for="textinput" id="lb_create_wl_name"><?php echo $arr_ui_string['ib_dlg_fields'][1]?></label>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<select class="selectpicker" id="cb_create_group"
								data-width="auto">
		            		<?php
																$arr = $list_group;
																for($i = 0; $i < count ( $arr ); $i ++) {
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<select class="selectpicker" id="cb_create_upper_agent"
								>
		            		<?php
																$arr = $list_agent;
																for($i = 0; $i < count ( $arr ); $i ++) {
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['ib_dlg_fields'][4]?>" class="form-control"  id="tv_create_comment_pt">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="textinput"><?php echo $arr_ui_string['ib_dlg_fields'][5]?></label>
						<div class="col-sm-7">
							<select class="selectpicker" id="cb_create_enabled"
								data-width="auto">
		            		<?php
																$arr = Array('Y', 'N');
																for($i = 0; $i < count ( $arr ); $i ++) {
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" placeholder="<?php echo $arr_ui_string['ib_dlg_fields'][6]?>" class="form-control"  id="tv_create_hierarchy">
						</div>
					</div>
